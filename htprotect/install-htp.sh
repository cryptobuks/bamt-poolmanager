...
echo "This script is intended to set up some basic security for your web service."
echo "It is distributed with BAMT-PoolManager, and intended to be used on BAMT and its derivatives."
